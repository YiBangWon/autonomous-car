        ...
        if line_flag != 3:
            ...
            for window in range(0, nwindows):
                if line_flag == 1:
                    ...
                    cv2.rectangle(out_img, (win_x_low + int(width * lineWidth) + 50, win_y_low), (win_x_high + int(width * lineWidth) + 50, win_y_high), (255, 0, 0), 1)
                    ...
                    cv2.rectangle(out_img, (win_x_low - int(width * lineWidth) - 50, win_y_low), (win_x_high - int(width * lineWidth) - 50, win_y_high), (0, 255, 0), 1)
