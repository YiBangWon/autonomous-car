...
int img_process(Mat &frame)
{
	...
	*/
	/*
	cvtColor(roi, dst, CV_BGR2YCrCb);
	inRange(dst, Scalar(220, 100, 100), Scalar(255, 150, 150), dst);
	int nonZero = countNonZero(dst);
	cout<<nonZero<<std::endl;
	if(nonZero>7000){
		differ = 10000;
	}*/
